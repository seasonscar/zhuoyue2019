...
public class MainController {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String[] sfj_new2 = {"苏轼","陆游"};
        String[] sfj_new = {"苏轼","陆游","王羲之","黄庭坚","李斯",
                "郑板桥","颜真卿","赵孟頫","李世民",
                "米芾",
                "贺知章",
                "张旭","郑燮","徐渭",
        ...
        try {
            ...
            //dataList=main.getUnionData(new String[]{"郑板桥","李东阳"});
            dataList=main.getSplitYearData(new String[]{"李东阳"},"1969-2008");
...
//            }
            ...
            transCsvData("1", dataList);//"0":总数 "1":分年
        }
    }


    public List<Map<String, String>> getSplitYearData(String[] nameArray,String yearRegion) throws InterruptedException, IOException, AntiSpriderException {
    ...
    public List<Map<String, String>> getUnionData(String[] nameArray) throws InterruptedException, IOException, AntiSpriderException {
        List<Map<String, String>> retList=new ArrayList<>();
        int totalCount = 0;
        LoginCookieUtil login = new LoginCookieUtil();
        if (login.getCookie() == null || login.getLoginBody() == null) {
